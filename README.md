...
O WalletAI funciona como um conselheiro digital: a partir de informações como renda, gastos essenciais e não essenciais, ele analisa a situação financeira do usuário, identifica desequilíbrios e sugere ações diretas para otimizar o orçamento, reduzir excessos e estruturar metas de curto prazo. Além disso, o agente possui funcionalidades de cálculo, incluindo percentuais de gastos, distribuição ideal do orçamento e estimativas de economia com base nos valores fornecidos.
...
• “Quero juntar dinheiro para fazer uma viagem. Meu salário é [valor] e meus gastos atuais são [valor]. Quais estratégias posso adotar para economizar e organizar minha vida financeira até alcançar essa meta?”

• “Recebo [valor], gasto [valor] com coisas essenciais e [valor] com coisas não essenciais. O que posso ajustar para melhorar meu equilíbrio financeiro?”

• “Tenho objetivo de economizar [valor] por mês, mas não sei por onde começar. Com base na minha renda de [valor], como posso estruturar um plano simples para atingir essa meta?”
